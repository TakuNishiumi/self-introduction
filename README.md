...
1. ライトカーブモニター(LCM)の自作
   ...
   - ライトカーブモニターの[KELT-24 bへの利用例](https://github.com/TakuNishiumi/self-introduction/blob/main/LCM/190503_KELT-24_median_rin150_rout200.pdf)：横軸が時間で縦軸が天体の明るさの比やフォーカスの値、星像の大きさなどが記されている。
