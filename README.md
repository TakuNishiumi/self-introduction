...
1. ライトカーブモニター(LCM)の自作
   - 京都産業大学の荒木望遠鏡に備えられているCCDカメラで撮影された天体画像の光度をリアルタイムに計測し、画面上に表示するノートブックを作成した。これによりリアルタイムにデータを確認でき、光度変動する天体等はリアルタイムに変化がわかるようになった。もともとは他の大学のポスドクの方が作成されており、１から独自にコーディングし作成した。
